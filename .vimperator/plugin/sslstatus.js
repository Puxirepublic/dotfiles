...
const progressListener = {
    ...
    onSecurityChange: function onSecurityChange(webProgress, request, state) {
        if (state & Ci.nsIWebProgressListener.STATE_IS_INSECURE)
            ...
            highlight.set("StatusLine", "color:#fea63c; background:#171717;font-family:lemon;font-size:10px;");
        else if (state & Ci.nsIWebProgressListener.STATE_SECURE_HIGH)
            highlight.set("StatusLine", "color:#00aa88; background:#171717;font-family:lemon;font-size:10px;");
    }
};
